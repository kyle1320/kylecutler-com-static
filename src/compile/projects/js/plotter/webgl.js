window.onload = function() {
    ...
    function init() {
        ...
        loadFiles(['shader.vert', 'shader.frag'], function(files) {
            ...
            boundsUniform = gl.getUniformLocation(program, 'bounds');
    ...
    function render() {
        ...
        gl.uniform2f(screenSizeUniform, gl.drawingBufferWidth, gl.drawingBufferHeight);
        gl.uniform4f(boundsUniform, -10, -10, 10, 10);
