...
window.onload = function () {
    ...
    function init() {
        ...
        inputs.evolveBtn.addEventListener('click', function () {
    ...
    function update() {
        if (evolving) sim.advance();else game.update(sim.bestnet);
    ...
    // draw to the canvas
    function draw() {
        if (sim.bestnet) sim.bestnet.draw(netCanvas, netContext);
